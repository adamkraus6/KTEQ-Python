...
class SwearLog():
    ...
    def postJSON(self):
        sw = {
            'date':             self.swearDate     ,
            'time':             self.swearTime     ,
            'song title':       self.swearSong     ,
            'song artist':      self.swearArtist   ,
            'song composer':    self.swearComposer ,
            'show name':        self.swearShow     ,
            'report':           self.swearReport   ,
        }
        with open('swear.json', 'w') as outfile:
            json.dump(sw, outfile)
